...
function RegisterActions()
    ...
    ;BINDER
    SkyrimNetApi.RegisterAction("ArcbotAddArmbinder", "Equip a armbinder made of {color} {material} on {target} to bind their hands", "arcs_DeviousEligibility", "ArcbotAddArmbinder_IsEligible", \
    ...
    ;BELT
    SkyrimNetApi.RegisterAction("ArcbotAddChastityBelt", "Equip a {color} {type} chastity belt over {target}'s hips", "arcs_DeviousEligibility", "ArcbotAddChastityBelt_IsEligible", \
    ...
    ;BLINDFOLD        
    SkyrimNetApi.RegisterAction("ArcbotAddBlindfold", "Equip a blindfold made of {color} {material} over {target}'s eyes'", "arcs_DeviousEligibility", "ArcbotAddBlindfold_IsEligible", \
    ...
    ;BOOTS
    SkyrimNetApi.RegisterAction("ArcbotAddSlaveBoots", "Equip a slave boots made of {color} {material} on {target} to their feet", "arcs_DeviousEligibility", "ArcbotAddSlaveBoots_IsEligible", \
    ...
    ;COLLAR
    SkyrimNetApi.RegisterAction("ArcbotAddCollar", "Equip a collar made of {color} {material} on {target}'s neck", "arcs_DeviousEligibility", "ArcbotAddCollar_IsEligible", \
    ...
    SkyrimNetApi.RegisterAction("ArcbotAddCorset", "Equip a collar made of {color} {material} on {target}'s waist", "arcs_DeviousEligibility", "ArcbotAddCorset_IsEligible", \
        "arcs_DeviousExecution", "ArcbotAddCorset_Execute", "", "PAPYRUS", 1, "{\"target\":\"Actor\",\"material\":\"ebonite|leather|rope\",\"color\":\"black|red|white\"}", "", "")  

    SkyrimNetApi.RegisterAction("ArcbotRemoveCorset", "Remove a collar from {target}'s waist", "arcs_DeviousEligibility", "ArcbotRemoveCorset_IsEligible", \
        "arcs_DeviousExecution", "ArcbotRemoveCorset_Execute", "", "PAPYRUS", 1, "{\"target\":\"Actor\"}", "", "")  

    ;GAG
    SkyrimNetApi.RegisterAction("ArcbotAddGag", "Equip a gag made of {color} {material} in {target}'s mouth", "arcs_DeviousEligibility", "ArcbotAddGag_IsEligible", \
    ...
    ;GLOVES
    SkyrimNetApi.RegisterAction("ArcbotAddSlaveGloves", "Equip a slave gloves made of {color} {material} on {target}'s hands", "arcs_DeviousEligibility", "ArcbotAddSlaveGloves_IsEligible", \
    ...
    ;HARNESS
    SkyrimNetApi.RegisterAction("ArcbotAddHarness", "Equip a harness made of {color} {material} over {target}'s chest", "arcs_DeviousEligibility", "ArcbotAddHarness_IsEligible", \
    ...
    SkyrimNetApi.RegisterAction("ArcbotRemoveHarness", "Remove a harness from {target}'s chest", "arcs_DeviousEligibility", "ArcbotRemoveHarness_IsEligible", \
        "arcs_DeviousExecution", "ArcbotRemoveHarness_Execute", "", "PAPYRUS", 1, "{\"target\":\"Actor\"}", "", "")  

    ;HOOD
    SkyrimNetApi.RegisterAction("ArcbotAddHood", "Equip a {color} hood over {target}'s head", "arcs_DeviousEligibility", "ArcbotAddHood_IsEligible", \
